...
//    private Double price;        // Giá của món ăn (sử dụng Double để có thể là null)
...
//        this.quantity = 1;
//        this.status = "Chưa được đặt"; // Loại bỏ khoảng trắng
//    }
//
...
//                price != null && price >= 0 && // Kiểm tra giá không null
//                quantity > 0;
//    }
//
...
//        price = in.readDouble(); // Có thể cần kiểm tra giá trị null
...
//        dest.writeDouble(price != null ? price : 0.0); // Kiểm tra giá trị null
