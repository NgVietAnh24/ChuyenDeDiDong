...
//        }
//
//        // Load previously selected foods from ViewModel or Firestore
...
//        } else {
//            loadSelectedFoodsFromFirebase(); // Load from Firestore if no original food list
//        }
//
//        // Set tableId
//        findAndSetTableId();
...
//                    .get()
//                    .addOnSuccessListener(queryDocumentSnapshots -> {
//                        // Xóa tất cả các món ăn đã chọn cũ trong Firestore
//                        for (DocumentSnapshot doc : queryDocumentSnapshots.getDocuments()) {
//                            doc.getReference().delete();
//                        }
//
//                        // Lưu danh sách món ăn đã chọn mới vào Firestore
//                        for (SelectedFood selectedFood : selectedFoodList) {
//                            selectedFood.setTableId(tableId); // Đặt tableId cho món ăn
//                            db.collection("selected_foods")
...
//            showCustomToast("Đã hủy đơn", 500);
//            finish();
//        });
//
//        btnPay.setOnClickListener(v -> {
//            createAndShowInvoice();
//            showCustomToast("Đang xử lý thanh toán", 500);
//        });
//
...
//        // Chuyển đổi giá thành chuỗi với định dạng VNĐ
//        tvFoodPrice.setText(String.format("%,.2f VNĐ", selectedFood.getPrice())); // Hoặc dùng (long) nếu không cần phần thập phân
...
//            itemData.put("hoa _don_id", invoiceId);
