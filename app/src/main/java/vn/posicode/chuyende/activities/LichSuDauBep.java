        ...
        firestore.collection("selectedFoods").addSnapshotListener((value, e) -> {
            ...
            if (value != null) {
                ...
                for (DocumentSnapshot document : value.getDocuments()) {
                    ...
                    // Thêm kiểm tra null cho monAn và monAn.getStatus()
                    if (monAn != null && monAn.getStatus() != null && monAn.getStatus().equals("Đã xong")) {
                ...
                if (chefAdapter == null) {
                    chefAdapter = new ChefAdapter(filteredMonAnList, firestore, tableId, this);
