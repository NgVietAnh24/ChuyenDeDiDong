...
import vn.posicode.chuyende.models.ThongKe;
...
//
        ...
        btnShowTool.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(QLThongKe.this, ThongKeMonDaBan.class);
        ...
        db.collection("ThongKe").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                if (value != null) {
                    ...
                    adapterYear = new ArrayAdapter<>(QLThongKe.this, android.R.layout.simple_spinner_item, yearList);
