...
public class MonAn implements Parcelable {
    private String id, name, price, image, category_id, category_name, status, time, ban_id, documentId, ghiChu, sLChef;
    private int soLuong, soLuongDaLay, soLuongGhiChu;
    ...
    protected MonAn(Parcel in) {
        ...
        sLChef = in.readString();
        ghiChu = in.readString();
        soLuongDaLay = in.readInt();
        soLuongGhiChu = in.readInt();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(sLChef);
        dest.writeString(ghiChu);
        dest.writeInt(soLuongDaLay);
        dest.writeInt(soLuongGhiChu);
    }
    ...
    public int getSoLuongGhiChu() {
        return soLuongGhiChu;
    }

    public void setSoLuongGhiChu(int soLuongGhiChu) {
        this.soLuongGhiChu = soLuongGhiChu;
    }
    ...
    public String getSLChef() {
        return sLChef;
    }

    public void setSLChef(String sLChef) {
        this.sLChef = sLChef;
    }
